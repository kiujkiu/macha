...
// 螺纹柱: 用户先要中空壁厚 3, 2026-09-15 改回实心 (同步正式件根部复核结论)。
...
stud_wall  = thr_min / 2;   // 螺纹柱实心 (2026-09-15 用户改回; 中空时为 3)
bore_d     = thr_min - 2 * stud_wall;   // = 0 (实心)
bore_depth = 0;     // 实心 (中空时 15)
