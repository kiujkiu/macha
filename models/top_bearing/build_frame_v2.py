"""
top_bearing frame v2 — STATIC bearing frames frame_A_v2 / frame_B_v2. PLA.
...
(M6 axial threads) sit in the OUTERMOST corner holes (±125, ±125)
→ POST_R = 125·√2 = 176.777  (v1 was 194.5).
...
PAD_D = 18.0
POST_R = 125.0 * math.sqrt(2.0)   # 176.777 — posts in the (±125,±125) grid corners
RIB_R0, RIB_R1 = 24.0, 164.0      # rib span (end 12.78 from pad centre)
...
print(f"POST_R = {POST_R:.3f} mm  (125·√2; v1 was 194.5)")
write_stl(frame_a, "frame_A_v2.stl")
write_stl(fb_print, "frame_B_v2.stl")
