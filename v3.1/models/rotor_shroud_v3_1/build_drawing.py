...
text(PAGE_W/2, 14, "POV 3D v3 — rotor_shroud_v3_1 转子电路罩 (两半对开; 本图管 A/B 两件)",
...
text(tb_x+4, tb_y+6, "POV 3D v3 结构件 — rotor_shroud_v3_1 转子电路罩 (屏底以下全封闭)", size=TXT_L)
...
text(tb_x+tb_w-4, tb_y+14.5, "2026-07-27  /  POV3D / v3 / rotor_shroud_v3_1 / shroud_half_A_v3_1.stl + shroud_half_B_v3_1.stl",
