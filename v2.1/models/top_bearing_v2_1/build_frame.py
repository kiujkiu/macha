"""
top_bearing frame v2.1 — STATIC bearing frames frame_A_v2_1 / frame_B_v2_1. PLA.
...
→ POST_R = 100·√2 = 141.421  (v2 was 176.777, v1 194.5).
...
PAD_D = 18.0
POST_R = 100.0 * math.sqrt(2.0)   # 141.421 — posts at (±100,±100) (v2.1: 内移 1 格)
RIB_R0 = 24.0
...
print(f"POST_R = {POST_R:.3f} mm  (100·√2; v2 was 176.777)")
write_stl(frame_a, "frame_A_v2_1.stl")
write_stl(fb_print, "frame_B_v2_1.stl")
