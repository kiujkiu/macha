"""
A3 drawing — top_cap_v3_1 薄压条 (v3 双面屏顶部, 2026-07-24 六改: 不加宽,
...
text(PAGE_W/2,15,"POV 3D v3 — top_cap_v3_1 双面屏顶部薄压条 (光电斜置, 光轴过圆心)",size=TXT_T,anchor="middle")
text(PAGE_W/2,21,f"扁条 {2*BLK_X:g}×{2*BLK_Y:g}×{H:g} (装配 {BAR_Z0:g}..{BAR_Z1:g}, 底面压双面屏顶) / "
     ...
     f"2×Φ{SCREW_D:g} @ (0,±64) 盘头 M3×12 锁屏顶 (中央孔被轴占, 空置)",
...
text(tb_x+4,tb_y+6,"POV 3D v3 结构件 — top_cap_v3_1 薄压条 (光电斜置, 底面 = 屏顶压面 260.95)",size=TXT_L)
...
text(tb_x+4,tb_y+14.5,f"{2*BLK_X:g}×{2*BLK_Y:g}×{H:g} / 轴 Φ{AXIS_BORE:g}+Φ{HEAD_D:g}×{HEAD_T:g} 底头窝 / 2×Φ{SCREW_D:g}@±64 / "
     f"光电 2×Φ3.2 绕 M(0,-45) 转 {SEN_TH:.2f}° + Φ{SEN_CB_D:g} 头窝 / BOM: M6×20 平头 + Φ8×30 螺柱 + M3×12×4 / 平躺打印 / 单位 mm",size=TXT_I)
text(tb_x+tb_w-4,tb_y+14.5,"2026-07-24  /  POV3D / v3 / top_cap_v3_1 / top_cap_v3_1.stl",size=TXT_I,anchor="end")
