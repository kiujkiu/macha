...
(随架, = 筋底 asm 290)。
  ...
  · 板: X 42.2..54.4 × Y 2..6 (厚 4) × Z 0..8 —— 恰好填满筋侧面
    (2026-07-24 四改, 用户: 板顶到底 → 底与筋底平 asm 290, 顶抵臂底
    asm 298 成定位靠面, 装时向上顶到位+防转); 2×Φ3.2 圆孔在板正中
    (X 45.2 / 51.4, Z 4) 对齐筋孔; 板底对旋转叉顶 285.65 余 4.35+δ
...
打印: 平躺 (Y=2 面贴床), 足迹 12.2×50, 高 4, 零支撑。
...
PLATE_X0, PLATE_X1 = 42.2, 54.4
PLATE_Y0, PLATE_Y1 = 2.0, 6.0
PLATE_Z1 = 8.0                       # = 筋高, 底平筋底 / 顶抵臂底 (定位靠面)
HOLE_XS, HOLE_D = (45.2, 51.4), 3.2
